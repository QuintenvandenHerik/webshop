  ...
  width: 50%; text-align: center;">
        ...
        <div class="products">
            @foreach ($products as $product)
                <a href="addToCart/<?php echo $product->id ?>" class="product" style="margin: auto; width: 200px; height: 200px; text-align: center; border: black; border-style: solid; display: inline-block; margin: 10px; text-decoration: none; color: black;">
